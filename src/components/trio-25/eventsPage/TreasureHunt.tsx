        ...
        <div className="max-w-xl mx-auto bg-neutral-800 rounded-xl p-8 shadow-lg">
          ...
          >
            <div className="mb-4">
              ...
              <input
                type="text"
                name="entry.1234567890" // replace with your actual Google Form field ID
                value={name}
            ...
            <div className="mb-4">
              ...
              <input
                type="tel"
                name="entry.0987654321" // replace with your actual Google Form field ID
                value={contact}
            ...
            <div className="mb-4 text-sm text-gray-400 italic">
              Rules and details will be announced soon. Stay tuned!
            </div>
